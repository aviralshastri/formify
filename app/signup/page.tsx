...
import { EyeIcon, EyeOffIcon, User, Phone, Mail, Lock, UserCircle } from 'lucide-react'
...
function Signup() {
  ...
  const handleResendOtp = () => {
    console.log(`Resending OTP to ${otpType}`)
  }
            ...
            <div className="space-y-2">
              ...
              <div className="flex space-x-2">
                ...
                <Button
                  ...
                  disabled={!!errors.phone || isPhoneVerified || formData.phone.length === 0}
                  className={`h-11 ${isPhoneVerified ? 'bg-green-600 hover:bg-green-700' : ''}`}
                >
            ...
            <div className="space-y-2">
              ...
              <div className="flex space-x-2">
                ...
                <Button
                  ...
                  disabled={!!errors.email || isEmailVerified || formData.email.length === 0}
                  className={`h-11 ${isEmailVerified ? 'bg-green-600 hover:bg-green-700' : ''}`}
                >
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1">
                ...
                <Progress 
                  ...
                  style={{
                    background: '#e5e7eb',
                    color: passwordStrength >= 75 ? '#22c55e' : 
